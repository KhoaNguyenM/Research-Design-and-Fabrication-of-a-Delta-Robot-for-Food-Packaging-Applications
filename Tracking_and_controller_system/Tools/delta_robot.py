...
if __name__ == "__main__":
    ...
    x, y, z = 0, 80, -550  # Position 
    status, theta1, theta2, theta3 = delta_calcInverse(x, y, z)
    theta1v = theta1 - 2.1327
    theta2v = theta2 - 2.1327
    theta3v = theta3 - 2.1327
    if status == 0:
        print(f"Inverse Kinematics: theta1 = {theta1v:.2f}°, theta2 = {theta2v:.2f}°, theta3 = {theta3v:.2f}°")
    else:
